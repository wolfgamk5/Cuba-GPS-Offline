...
fun CubaMapLibreView(
    ...
    // MapLibre.getInstance(...) ya se llama una sola vez al arrancar la app, en
    // CrashLoggingApplication.onCreate() — no debe llamarse aquí (Compose puede crear este
    // MapView en una subcomposición de Scaffold antes de que este punto se ejecute).
